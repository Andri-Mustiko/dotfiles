return {
{
    ...
    dependencies = {
        ...
        { 'mason-org/mason-lspconfig.nvim',
            opts = {
                -- Automatically install specific servers
    ...
    config = function()
        vim.api.nvim_create_autocmd('LspAttach', {
            ...
            map('<leader>ca', vim.lsp.buf.code_acion, '[C]ode [A]ction', { 'n', 'x' })
            ...
            map('gt', function() Snacks.picker.lsp_type_definitions() end, '[G]oto [T]ype Definiton')
    ...
    vim.diagnostic.config {
        ...
        signs = vim.g.have_nerd_font and {
            text = {
                --[vim.diagnostic.severity.ERROR] = 'ㄦ',
                --[vim.diagnostic.severity.WARN] = 'わ',
                --[vim.diagnostic.severity.INFO] = 'に',
                --[vim.diagnostic.severity.HINT] = 'ひ',
            },
        } or {},
        virtual_text = {
            source = 'if_many',
            ...
            format = function(diagnostic)
                ...
                return diagnostic_message[diagnostic.severty]
            end,
        },
    }
    ...
    require('mason-lspconfig').setup {
        ...
        handlers = {
            function(server_name)
                local seerver = servers[server_name] or {}
